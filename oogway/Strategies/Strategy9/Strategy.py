...
#strategy_2
async def backtest_with_money_strategy_9(predicts: list[Predict], my_money:float, close_tp:int=0, showPrint: bool= False, positionSize: float= 100, max_percent_stoploss: float=5):

...
class Strategy14(AbsStrategy):
    ...
    async def backtest_with_money_strategy_14(self, predicts: list[Predict], showPrint: bool= False, max_percent_stoploss: float= 2,
                                               max_percent_tp: float= 4, positionSize: float= 100):

...
class AbsStrategy(ABC):
    ...
    def addTrendErrorOrder(self, order:Predict):
        self.trend_error_orders.append(model_to_dict(order))
        self.orders_status.append({
            'date': order.date.astimezone(self.time_zone_pytz),
            'active_date': None,
            'symbol': order.symbol.name,
    ...
    def addLossOrder(self, order:Predict, status_date:int, profit:float, position_size:float, money_back:float, type:int):
        """
            status_date is timestamp
        """
        # will handle milli second timestamp
    ...
    def addProfitOrder(self, order:Predict, status_date:int , profit:float, money_back:float, position_size:float, type:int):
        """
            status_date is timestamp
        """
        # will handle milli second timestamp
